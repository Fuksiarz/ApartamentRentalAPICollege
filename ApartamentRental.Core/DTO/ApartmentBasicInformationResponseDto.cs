...
public class ApartmentBasicInformationResponseDto
{
    ...
    public ApartmentBasicInformationResponseDto(decimal rentAmount, int numberOfRooms
        , decimal squareMeters, bool isElevatorInBuilding, string city, string street)
    {
